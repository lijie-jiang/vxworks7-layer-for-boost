...
Porting is currently focused on Intel BSP **itl_generic** using the GNU compiler with C++03 and 64bit support selected. Other configurations are selectable, but have not been verified by Wind River.
Not all Boost tests are passing, please see the [TestResults.md document](./docs/TestResults.md) for details. 
